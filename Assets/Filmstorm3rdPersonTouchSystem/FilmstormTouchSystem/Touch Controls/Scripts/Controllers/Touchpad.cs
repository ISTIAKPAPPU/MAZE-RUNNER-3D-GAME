...
namespace FilmstormTouch
{
...
#endif
    {
        ...
        private void OnEnable()
        {
            ...
            FilmstormTouchInputManager.RegisterVirtualAxis(_horizintalAxis);
            FilmstormTouchInputManager.RegisterVirtualAxis(_verticalAxis);
        }
        ...
        private void OnDisable()
        {
            ...
            FilmstormTouchInputManager.UnregisterVirtualAxis(_horizintalAxis);
            FilmstormTouchInputManager.UnregisterVirtualAxis(_verticalAxis);
        }
