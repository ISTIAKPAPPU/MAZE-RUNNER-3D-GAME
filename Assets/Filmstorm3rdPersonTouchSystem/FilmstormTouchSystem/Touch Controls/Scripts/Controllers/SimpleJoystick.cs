...
namespace FilmstormTouch
{
...
#endif
    {
        ...
        private void OnEnable()
        {
            ...
            FilmstormTouchInputManager.RegisterVirtualAxis(HorizintalAxis);
            FilmstormTouchInputManager.RegisterVirtualAxis(VerticalAxis);
        }
        ...
        private void OnDisable()
        {
            ...
            FilmstormTouchInputManager.UnregisterVirtualAxis(HorizintalAxis);
            FilmstormTouchInputManager.UnregisterVirtualAxis(VerticalAxis);
        }
