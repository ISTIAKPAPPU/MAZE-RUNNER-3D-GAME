...
namespace FilmstormTouch
{
    ...
    /// </summary>
    public class FilmstormTouchInputManager
    {
        private const float AlmostZero = 0.00000001f;

        private static FilmstormTouchInputManager _instance;

        private static FilmstormTouchInputManager Instance
        {
            get { return _instance ?? (_instance = new FilmstormTouchInputManager()); }
        }

        private FilmstormTouchInputManager() { }
