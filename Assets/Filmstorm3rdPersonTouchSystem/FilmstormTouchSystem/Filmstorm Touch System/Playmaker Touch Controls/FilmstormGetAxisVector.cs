...
namespace FilmstormTouch.Playmaker
{
    ...
    public class FilmstormInputGetAxisVector : FsmStateAction
    {
        ...
        public override void OnUpdate()
        {
            ...
            var h = (horizontalAxis.IsNone || string.IsNullOrEmpty(horizontalAxis.Value)) ? 0f : FilmstormTouchInputManager.GetAxis(horizontalAxis.Value);
            var v = (verticalAxis.IsNone || string.IsNullOrEmpty(verticalAxis.Value)) ? 0f : FilmstormTouchInputManager.GetAxis(verticalAxis.Value);
